 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTL | LAlt | LGUI |Space | /Raise  /       \Lower \  |Space | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,   KC_GAMING,KC_N, KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
            KC_LCTL,KC_LALT,KC_LGUI, KC_SPC, KC_LOWER,      KC_RAISE,  KC_SPC, KC_RGUI, KC_RALT, KC_RCTL
),
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Caps |   A  |   S  |   D  |   F  |   G  |-------.    ,-------|   H  |   J  |   K  |   L  |  Up  |Enter |
 * |------+------+------+------+------+------|  mute |    | QWERTY|------+------+------+------+------+------|
 * |LShift|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  | Left | Down | Right|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTL | LAlt | LGUI |Space | /Raise  /       \Raise \  |  [   |  ]   |  -   |  =   |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_GAMING] = LAYOUT(
  ...
  KC_CAPS,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_UP,  KC_ENT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_QWERTY,KC_N,    KC_M, KC_COMM,  KC_LEFT, KC_DOWN,  KC_RIGHT,
                 KC_LCTL,KC_LALT,KC_LGUI, KC_SPC, KC_LOWER,      KC_RAISE,  KC_LBRC, KC_RBRC, KC_MINS, KC_EQL
),
