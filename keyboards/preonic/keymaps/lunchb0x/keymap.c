...
[_NUMPAD] = LAYOUT_preonic_grid(
    ...
    _______, _______, _______, _______, _______, _______, KC_NLCK, KC_P1,    KC_P2,   KC_P3,   KC_PSLS, KC_DEL,
    _______, _______, _______, _______, _______, _______, _______, KC_P4,    KC_P5,   KC_P6,   KC_PAST, KC_PENT,
    KC_PGUP, _______, _______, TCOPY,   TPSTE,   _______, _______, KC_P7,    KC_P8,   KC_P9,   KC_PMNS, KC_PSCR,
    KC_PGDN, _______, _______, _______, _______, _______, _______, _______,  KC_P0,   KC_PDOT, KC_PPLS, _______
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |RGBprv| Reset|DEBUG | REC1 |PLAY1 |STPREC| REC2 |PLAY2 |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |RGBnxt|      |      |Aud on|AudOff|      | Home |Qwerty|Colmak|      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  _______, KC_HOME, QWERTY, COLEMAK, _______,  _______, _______,
