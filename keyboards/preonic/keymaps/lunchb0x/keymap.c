...
[_NUMPAD] = LAYOUT_preonic_grid(
    ...
    _______, _______, _______, _______, _______, _______, KC_LNUM, KC_P1,    KC_P2,   KC_P3,   KC_PSLS, KC_DEL,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |RGBprv| Reset|      | REC1 |PLAY1 |STPREC| REC2 |PLAY2 |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, _______, MI_MOD,  AU_ON,   AU_OFF,  _______, KC_HOME, QWERTY, COLEMAK, _______,  _______, _______,
